...
using SkorubaIS4Admin.Admin.Api.Configuration;
using SkorubaIS4Admin.Admin.Api.Configuration.Authorization;
using SkorubaIS4Admin.Admin.Api.ExceptionHandling;
using SkorubaIS4Admin.Admin.Api.Helpers;
using SkorubaIS4Admin.Admin.Api.Mappers;
using SkorubaIS4Admin.Admin.Api.Resources;
using SkorubaIS4Admin.Admin.EntityFramework.Shared.DbContexts;
using SkorubaIS4Admin.Admin.EntityFramework.Shared.Entities.Identity;
using SkorubaIS4Admin.Shared.Dtos;
using SkorubaIS4Admin.Shared.Dtos.Identity;
using System;
using System.Collections.Generic;
using System.IdentityModel.Tokens.Jwt;

namespace SkorubaIS4Admin.Admin.Api
{
